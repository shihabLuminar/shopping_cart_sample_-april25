  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text(
          productProvider.productDetails?.title ?? "",
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 20),
                        Text(
                          "${productProvider.productDetails?.rating}/5 Rating",
                          style: TextStyle(
                              color: Colors.amber,
                              fontWeight: FontWeight.bold,
                              fontSize: 16),
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text(
                            "RS ${productProvider.productDetails?.price ?? ""}",
                            style: TextStyle(
                                color: Colors.black,
                                fontWeight: FontWeight.bold,
                                fontSize: 20),
                        ...
                        child: InkWell(
                          onTap: () async {
                            await context.read<CartController>().addTocart(
                                context, productProvider.productDetails!);
                            Navigator.push(
                                context,
                                MaterialPageRoute(
